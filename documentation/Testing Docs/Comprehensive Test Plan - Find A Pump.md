...
TEST ID: FN-BB-E2E-001Priority: P0 (Critical)Description: Startup and map baseline workflowTest Steps:
...
TEST ID: FN-BB-E2E-002Priority: P0 (Critical)Description: Allow location and show nearby stationsTest Steps:
...
TEST ID: FN-BB-E2E-003Priority: P1 (High)Description: Location denied fallback workflowTest Steps:
...
TEST ID: FN-BB-E2E-004Priority: P1 (High)Description: Tasks CRUD flow via API clientTest Steps:
...
- TEST ID: NF-NF-LOAD-001Description: Load smoke test for endpoint latency and error rateCommand: `pnpm test:nf:load`
